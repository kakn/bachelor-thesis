...
!!! Crime = godfather, trainspotting, no country
!!! How will I have 2 models for each genre if they converge? What would be the point of that
"""
...
def training(training_model, encoder_input_data, decoder_input_data, decoder_target_data, epochs, batch_size):
    ...
    csv_logger = CSVLogger("double_model_history_log.csv", append=True)
    ...
    training_model.save_weights('2k600e32b.h5')
...
def modellen(training_model, decoder_inputs, decoder_lstm):
    ...
    if nowtrain == False:
        training_model.load_weights('2k600e32b.h5')
        print("working!")
