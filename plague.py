...
+ Save history!!!!!!!
+ Save weights and architecture instead of model
+ Make sure preprocessing is consistent across reruns
...
def training(training_model, encoder_input_data, decoder_input_data, decoder_target_data, epochs, batch_size):
    ...
    training_model.save_weights('modweit.h5')

def modellen(training_model, decoder_inputs, decoder_lstm):
    global decoder_model
    global encoder_model
    if nowtrain == False:
        training_model.load_weights('modweit.h5')
        print("working!")
