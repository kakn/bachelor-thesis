...
def training(training_model, encoder_input_data, decoder_input_data, decoder_target_data, epochs, batch_size):
    ...
    nowtrain = True
    csv_logger = CSVLogger("smallcomedy_model_history_log.csv", append=True)
    ...
    training_model.save_weights('smallcomedy.h5')
...
def modellen(training_model, decoder_inputs, decoder_lstm):
    ...
    if nowtrain == False:
        training_model.load_weights('smallcomedy.h5')
        print("working!")
